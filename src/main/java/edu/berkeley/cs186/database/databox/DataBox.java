 ...
 *   - longs with new LongDataBox(l), and
 *   - dates with new DateDataBox(Date date) or new DateDataBox(String dateString).
 *
 ...
 *     case DATE:   { System.out.println(d.getDate()); }
 *   }
 */
public abstract class DataBox implements Comparable<DataBox> {
    ...
    public Date getDate() {
        throw new RuntimeException("not Date type");
    }
    ...
    public static DataBox fromBytes(Buffer buf, Type type) {
        switch (type.getTypeId()) {
            ...
            case DATE: {
                return new DateDataBox(buf.getLong());
            }
            default: {
    ...
    public static DataBox fromString(Type type, String s) {
        ...
        switch (type.getTypeId()) {
            ...
            case DATE: return new DateDataBox(s);
    ...
    public static DataBox fromObject(Object o) {
        ...
        if (o instanceof Date) return new DateDataBox((Date) o);
